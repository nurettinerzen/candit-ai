...
Object.assign(EN_PHRASE_TRANSLATIONS, {
  "İK ekibinin günlük operasyonu ve üst yönetim raporlaması için kritik KPI'ları tek ekranda izleyin.": "Track the critical KPIs for your HR team's daily operations and executive reporting on a single screen.",
  "Aktif ilanlar": "Active job posts",
  "Toplam başvuru": "Total applications",
  "Mülakat yapılan aday": "Candidates interviewed",
  "Tahmini zaman kazancı": "Estimated time saved",
  "Yönetici özeti": "Executive summary",
  "Yönetim toplantısında tek slayta konabilecek en kritik sinyaller.": "The most important signals you can put on a single slide for an executive meeting.",
  "Yönetime sunulacak temel sinyalleri özetler.": "Summarizes the core signals to present to leadership.",
  "AI katkısı ve karşılaştırma": "AI contribution and comparison",
  "Manuel iş yüküyle kıyaslandığında sistemin oluşturduğu tahmini kazanımı gösterir.": "Shows the estimated gains the system creates compared with manual workload.",
  "Sistemin manuel iş yüküne göre yarattığı tahmini kazanımı gösterir.": "Shows the estimated savings the system creates compared with manual workload.",
  "Ön değerlendirme hazır": "Pre-screening ready",
  "Screening veya fit score üretilen başvuruların oranı.": "The share of applications with screening or fit score output.",
  "İlk mülakata geçiş": "Time to first interview",
  "Başvuru ile ilk mülakat planı arasındaki ortalama süre.": "Average time between application and the first interview plan.",
  "Mülakat tamamlanma oranı": "Interview completion rate",
  "Planlanan oturumların ne kadarının tamamlandığını gösterir.": "Shows how many planned sessions were completed.",
  "AI görev başarı oranı": "AI task success rate",
  "Terminal AI görevlerinde başarı oranı.": "Success rate across terminal AI tasks.",
  "Screening kazanımı": "Screening savings",
  "başvuruda AI ön değerlendirme üretildi.": "applications have AI pre-screening output.",
  "Mülakat analizi kazanımı": "Interview analysis savings",
  "oturum için rapor veya analiz çıkışı mevcut.": "sessions have report or analysis output.",
  "Planlama kazanımı": "Scheduling savings",
  "oturum AI destekli veya otomasyonla planlanmış.": "sessions were planned with AI support or automation.",
  "Toplam tahmini kazanç": "Total estimated savings",
  "Mülakat operasyonu": "Interview operations",
  "Toplam oturum": "Total sessions",
  "Tamamlanan oturum": "Completed sessions",
  "Ortalama görüşme süresi": "Average interview duration",
  "Ekip performansını ve görüşme akışının sağlığını izleyin.": "Monitor team performance and the health of your interview flow.",
  "Mülakat akışının hacmini ve verimini izleyin.": "Monitor the volume and efficiency of your interview flow.",
  "Henüz mülakat verisi bulunmuyor.": "There is no interview data yet.",
  "Planlanan, devam eden, tamamlanan veya sonuçlanmayan tüm mülakat oturumları.": "All interview sessions that were planned, in progress, completed, or left unresolved.",
  "Adayın görüşmeyi başarıyla tamamladığı oturum sayısı.": "The number of sessions the candidate completed successfully.",
  "Tamamlanma oranı": "Completion rate",
  "Tamamlanan oturumların tüm mülakat oturumlarına oranı.": "The share of completed sessions among all interview sessions.",
  "Tamamlanan oturumların ortalama süresi.": "The average duration of completed sessions.",
  "Medyan görüşme süresi": "Median interview duration",
  "Tamamlanan oturumlarda ortadaki süreyi gösterir; uç değerlerden daha az etkilenir.": "Shows the midpoint duration of completed sessions; it is less affected by outliers.",
  "Adayın katılmadığı oturumların toplam oturumlara oranı.": "The share of sessions the candidate did not attend among all sessions.",
  "Sistem veya otomasyon desteğiyle planlanan oturumların oranı.": "The share of sessions scheduled with system or automation support.",
  "gerçekleşme oranı": "completion rate",
  "Medyan": "Median",
  "No-show oranı": "No-show rate",
  "No-show, iptal ve başarısız oturumların etkisini izleyin.": "Track the impact of no-shows, cancellations, and failed sessions.",
  "AI ile planlanan oturum oranı": "AI-scheduled session rate",
  "Planlama yükünün ne kadarının sistem tarafından üstlenildiğini gösterir.": "Shows how much of the scheduling load is handled by the system.",
  "Süreç hızı ve KPI tanımı": "Process speed and KPI definitions",
  "Sorulan metriklerin neye göre hesaplandığını burada açık gösteriyoruz.": "We clearly show how the requested metrics are calculated here.",
  "Sistemin doğrudan etkilediği hız metriklerini görün.": "See the speed metrics the system directly influences.",
  "Ön değerlendirme dönüş süresi": "Pre-screening turnaround time",
  "Başvuru tarihi ile ilk AI screening veya fit score çıkışı arasındaki ortalama süre.": "Average time between the application date and the first AI screening or fit score output.",
  "İlk mülakata geçiş süresi": "Time to first interview",
  "Başvuru tarihi ile ilk mülakat planlama tarihi arasındaki ortalama fark.": "Average gap between the application date and the first interview scheduling date.",
  "Henüz HIRED aşamasına geçen aday olmadığı için bu metrik oluşmadı.": "This metric is not available yet because no candidate has reached the HIRED stage.",
  "Rapor güveni": "Report confidence",
  "Aşama dağılımı": "Stage distribution",
  "Pipeline'da hangi aşamada ne kadar aday olduğunu gösterir.": "Shows how many candidates are in each stage of the pipeline.",
  "Dönüşüm ve AI kapsamı": "Conversion and AI coverage",
  "Operasyonel dönüşüm oranlarını ve AI çıktı kalitesini birlikte izleyin.": "Monitor operational conversion rates and AI output quality together.",
  "Teklif / ileri aşama oranı": "Offer / advanced-stage rate",
  "Başvuruların kısa liste veya ön eleme aşamasına taşınma oranı.": "The rate at which applications move into shortlist or pre-screening stages.",
  "Başvuruların mülakat aşamasına taşınma oranı.": "The rate at which applications move into the interview stage.",
  "Başvuruların teklif veya daha ileri aşamalara taşınma oranı.": "The rate at which applications move into offer or later stages.",
  "AI ön değerlendirme kapsaması": "AI pre-screening coverage",
  "başvuruda AI sinyali var.": "applications have AI signals.",
  "Fit score ortalaması": "Average fit score",
  "Güven verisi henüz oluşmadı.": "Confidence data is not available yet.",
  "Güven ortalaması": "Average confidence",
  "AI rapor güveni": "AI report confidence",
  "AI görev başarı verisi henüz oluşmadı.": "AI task success data is not available yet.",
