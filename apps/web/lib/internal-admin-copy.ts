...
const EN_INTERNAL_ADMIN_COPY = {
      ...
      settingsSubtitle: "Manage AI behavior, provider status, and system controls from one place.",
      redAlertTitle: "Red Alert",
      redAlertSubtitle:
        "Track security signals, application failures, assistant quality, and operational issues in one place.",
      usersTitle: "Users",
      usersSubtitle: "Manage customer company accounts, owners, plans, and usage from a single list.",
      leadsTitle: "Lead Inbox",
      leadsSubtitle: "Review public contact submissions, update their status, and keep the contact pipeline visible.",
      ...
      accountDetailSubtitle: "Review billing, usage, and owner access for the selected company account.",
      refresh: "Refresh",
      retry: "Retry",
      ...
      allWorkspaceStatuses: "All Company Statuses",
      ...
      workspaceStatus: "Company Status",
      ...
      addQuota: "Add Quota",
      suspendWorkspace: "Suspend Company Account",
      activateWorkspace: "Activate Company Account",
      ...
      internalOnly: "This area is restricted to authorized administrators.",
      ...
      suspendWorkspaceConfirm: "Suspend Company Account",
      activateWorkspaceConfirm: "Activate Company Account",
      deleteWorkspaceConfirm: "Mark as Deleted",
      ownerResetInfo: "Sends a fresh invitation link to the company account owner and revokes existing sessions.",
      ...
      workspaceStatusSaved: "Company status updated.",
      ...
      openCustomerWorkspace: "Open Customer Account",
      linkSent: "Link Sent",
      notSent: "Not Sent"
};
...
const TR_INTERNAL_ADMIN_COPY = {
    ...
    settingsSubtitle: "AI davranışını, sağlayıcı durumunu ve sistem kontrollerini tek yerden yönetin.",
    ...
    usersSubtitle: "Müşteri şirket hesaplarını, hesap sahiplerini, planları ve kullanımı tek listeden yönetin.",
    leadsTitle: "Lead Inbox",
    leadsSubtitle: "Public contact kayıtlarını görün, durumlarını güncelleyin ve iletişim hattını görünür tutun.",
    ...
    accountDetailSubtitle: "Seçili şirket hesabının abonelik, kullanım ve sahip erişimini yönetin.",
    refresh: "Yenile",
    retry: "Tekrar dene",
    ...
    allWorkspaceStatuses: "Tüm Şirket Durumları",
    ...
    suspendWorkspace: "Şirket Hesabını Askıya Al",
    activateWorkspace: "Şirket Hesabını Aktifleştir",
    ...
    internalOnly: "Bu alan yalnızca yetkili yöneticilere açıktır.",
    ...
    suspendWorkspaceConfirm: "Şirket Hesabını Askıya Al",
    activateWorkspaceConfirm: "Şirket Hesabını Aktifleştir",
    deleteWorkspaceConfirm: "Silinmiş Olarak İşaretle",
    ownerResetInfo: "Şirket hesabı sahibine yeni bir davet linki gönderir ve mevcut oturumları kapatır.",
    ...
    workspaceStatusSaved: "Şirket durumu güncellendi.",
    ...
    openCustomerWorkspace: "Müşteri Hesabını Aç",
...
export function translateInternalAdminMessage(message: string, locale: SiteLocale) {
  ...
  const exactMap: Record<string, string> = {
    "Bu alan yalnızca yetkili yöneticiler için açıktır.": "This area is restricted to authorized administrators.",
    ...
    "Yeni müşteri kaydı için benzersiz şirket hesabı ID üretilemedi.": "A unique company account ID could not be generated for the new customer.",
