...
export function getInternalAdminCopy(locale: SiteLocale) {
  if (locale === "en") {
    return {
      ...
      dashboardSubtitle: "Platform-wide customer, risk, and commercial operations overview.",
      ...
      searchUsersPlaceholder: "Search by customer, owner, or billing email...",
  ...
  return {
    ...
    dashboardSubtitle: "Platform genelindeki müşteri, risk ve ticari operasyon görünümü.",
    ...
    searchUsersPlaceholder: "Müşteri, sahip veya fatura e-postası ara...",
    ...
    workspaceOwner: "Çalışma Alanı Sahibi",
